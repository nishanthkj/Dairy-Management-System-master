...
<head>
    ...
    <style>
        ...
        .banner-area {
            ...
            background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.4)), url('images/main.jpg');
            padding-bottom: 5px;
            height: 650px;
...
<body class="main-body">
    ...
    <div class="banner-area">
        ...
        <h2> Step into a world of agricultural and environmental harmony at our farmer-friendly and eco-conscious dairy</h2>
    ...
    <div class="section" id="aboutus">
        <div class="products">
            ...
            <br>
            <p>we provide our customers a wide variety of dairy products from organic milk to butter and cheese</span>
            <P>
                <a href="#">Read More</a>
        </div>
        <div class="products">
            ...
            <br>
            <p>To build a <span style="color:green">strong </span><span style="color:red">,healthy </span>and <span style="color:blue">nutritious</span> country by providing an employement to all small-scale farmers
            <P>
                <a href="#">Read More</a>
        </div>
        <div class="products">
        ...
        <footer>
            <div class="foot-main">
                ...
                <div class="foot2">
                    <h3>find us</h3>
                    <p>JP NAGAR </P>
                    <p>NEAR MAHADEVPURA</p>
                    <p>MYSORE-570004</p>
                    <p>TELEPHONE:7845251425</p>
                </div>
                <div class="foot3">
                    <h3>Contact us</h3>
                    ...
                    <form class="" action="" method="POST">
                        <input type="email" name="subscribe" class="emailid" placeholder="Enter Your Email ID" /><button type="submit" onclick=a href="www.gmail.com"><span class="maile">submit</span></button>
                ...
                <div class="foot4">
                    <h3>follow us on</h3>
                    <ul>
                        <li><a href="https://www.instagram.com/cow_dairy_farming_knl/"><i class="fab fa-instagram-square"></i></a></li>
                        <li><a href="https://www.facebook.com/groups/262531033857719/"><i class="fab fa-facebook-square"></i></i></a></li>
